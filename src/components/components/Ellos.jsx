  ...
  return (
    <>
      <div className="max-w-[1140px] px-3 mx-auto xl:my-36 lg:my-24 sm:my-16 my-14">
        <h2 className="text-center text-white md:text-5xl sm:text-4xl text-3xl font-normal ff_anton sm:leading-[57.60px] md:mb-16 mb-8">
        ...
        <p className="max-w-[883px] mx-auto text-center text-white text-base font-semibold ff_inter leading-relaxed mb-5 sm:mt-9 mt-5">
          ...
          en tus manos.<br/> Elige ganar. Elige exclusive game.
        </p>
      </div>
    </>
  );
