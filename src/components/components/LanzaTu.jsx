  ...
  return (
    <>
      <div className="max-w-[1140px] px-3 mx-auto">
        <div className="relative flex flex-col justify-center items-center rounded-2xl border border-white border-opacity-50 md:py-[103px] sm:py-20 py-14 overflow-hidden xl:my-36 lg:my-24 sm:my-16 my-14 max-sm:px-4">
          <img
            src={LanzatuBgLayer}
            alt="LanzatuBgLayer"
            className="absolute left-0 top-0 h-full w-full z-[1] opacity-80 mix-blend-lighten"
          />
          <p className="text-white sm:text-[32px] text-3xl text-center font-normal ff_anton leading-[41.60px]">
            lanza tu propia plataforma en sólo 2 semanas
          </p>
          <div className="relative cursor-pointer md:mt-10 mt-7">
            <a
              href=""
